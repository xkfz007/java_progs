...
public class SimplePaperSearchUI extends JFrame {
	...
	Search2 htmlSearcher=new Search2();
	String queryString="";
	int  indx=0;
	...
	private JDialog jDialog = null;  //  @jve:decl-index=0:visual-constraint="691,0"
	...
	private JDialog jDialog1 = null;  //  @jve:decl-index=0:visual-constraint="700,397"
	...
	private JPanel getJPanel1() {
		if (jPanel1 == null) {
			...
			jPanel1.setBounds(new Rectangle(12, 12, 615, 53));
	...
	private JComboBox getJComboBox() {
		if (jComboBox == null) {
			...
			jComboBox.setBounds(new Rectangle(5, 6, 87, 40));
			//根据html建的索引进行搜索
	...
	private JTextField getJTextField() {
		if (jTextField == null) {
			...
			jTextField.setBounds(new Rectangle(97, 6, 208, 40));
	...
	private JButton getJButton() {
		if (jButton == null) {
			jButton = new JButton();
			jButton.setBounds(new Rectangle(378, 12, 67, 31));
...
public void htmlSingleFiedlSearch()
{
	...
	if(!queryString.equals(""))
	{
		...
		topDocs=htmlSearcher.getTopDocs(queryString,field,fuzzy);
...
//		显示搜索时间和文档数目
	...
	private JButton getJButton1() {
		if (jButton1 == null) {
			...
			jButton1.setBounds(new Rectangle(520, 3, 82, 39));
	...
	private JScrollPane getJScrollPane() {
		if (jScrollPane == null) {
			...
			jScrollPane.setBounds(new Rectangle(14, 125, 616, 510));
	...
	private JPanel getJPanel2() {
		if (jPanel2 == null) {
			jLabel = new JLabel();
			jLabel.setText("");
			jLabel.setBounds(new Rectangle(2, 2, 499, 46));
			jLabel.setBorder(new  EtchedBorder());
			jPanel2 = new JPanel();
			jPanel2.setLayout(null);
			jPanel2.setBounds(new Rectangle(13, 68, 615, 53));
	...
	private JButton getJButton2() {
		if (jButton2 == null) {
			...
			jButton2.setBounds(new Rectangle(450, 11, 84, 33));
	...
	private JCheckBox getJCheckBox() {
		if (jCheckBox == null) {
			...
			jCheckBox.setBounds(new Rectangle(308, 14, 55, 28));
	...
	private JTextField getJTextField1() {
		if (jTextField1 == null) {
			...
			jTextField1.setBounds(new Rectangle(104, 4, 177, 28));
		}
		return jTextField1;
	}
	...
	private JTextField getJTextField6() {
		if (jTextField6 == null) {
			...
			jTextField6.setBounds(new Rectangle(23, 13, 250, 45));
		}
		return jTextField6;
	}
	...
	private JCheckBox getJCheckBox5() {
		if (jCheckBox5 == null) {
			...
			jCheckBox5.setText("PublishTime");
			jCheckBox5.setBounds(new Rectangle(4, 4, 102, 31));
	...
	private JTextField getJTextField7() {
		if (jTextField7 == null) {
			...
			jTextField7.setBounds(new Rectangle(97, 5, 76, 28));
	...
	private JPanel getJPanel10() {
		if (jPanel10 == null) {
			...
			jPanel10.setBounds(new Rectangle(25, 60, 237, 37));
	...
	private JPanel getJPanel11() {
		if (jPanel11 == null) {
			...
			jPanel11.setBounds(new Rectangle(26, 100, 235, 31));
	...
	private JPanel getJPanel12() {
		if (jPanel12 == null) {
			...
			jPanel12.setBounds(new Rectangle(27, 133, 234, 33));
	...
	private JPanel getJPanel13() {
		if (jPanel13 == null) {
			...
			jPanel13.setBounds(new Rectangle(28, 169, 231, 36));
	...
	private JPanel getJPanel14() {
		if (jPanel14 == null) {
			...
			jPanel14.setBounds(new Rectangle(30, 206, 231, 40));
	...
	private JTextField getJTextField8() {
		if (jTextField8 == null) {
			...
			jTextField8.setBounds(new Rectangle(94, 6, 83, 22));
	...
	private JTextField getJTextField9() {
		if (jTextField9 == null) {
			...
			jTextField9.setBounds(new Rectangle(100, 6, 89, 22));
	...
	private JTextField getJTextField10() {
		if (jTextField10 == null) {
			...
			jTextField10.setBounds(new Rectangle(104, 5, 90, 25));
	...
	private JTextField getJTextField11() {
		if (jTextField11 == null) {
			...
			jTextField11.setBounds(new Rectangle(108, 8, 95, 26));
	...
	private JButton getJButton4() {
		if (jButton4 == null) {
			...
			jButton4.setBounds(new Rectangle(73, 259, 96, 31));
	...
	private JButton getJButton6() {
		if (jButton6 == null) {
			...
			jButton6.setBounds(new Rectangle(188, 260, 86, 29));
	...
	private JComboBox getJComboBox1() {
		if (jComboBox1 == null) {
			...
			jComboBox1.setBounds(new Rectangle(543, 8, 66, 37));
	...
	private JDialog getJDialog1() {
		if (jDialog1 == null) {
			...
			jDialog1.setSize(new Dimension(356, 391));
	...
	private JPanel getJPanel31() {
		if (jPanel31 == null) {
			...
			jPanel31.setBounds(new Rectangle(18, 18, 292, 39));
	...
	private JPanel getJPanel61() {
		if (jPanel61 == null) {
			...
			jPanel61.setBounds(new Rectangle(19, 71, 293, 50));
	...
	private JButton getJButton31() {
		if (jButton31 == null) {
			...
			jButton31.setBounds(new Rectangle(81, 269, 80, 31));
	...
	private JButton getJButton51() {
		if (jButton51 == null) {
			...
			jButton51.setBounds(new Rectangle(170, 269, 83, 30));
	...
	private JPanel getJPanel101() {
		if (jPanel101 == null) {
			...
			jPanel101.setBounds(new Rectangle(25, 60, 237, 37));
	...
	private JPanel getJPanel131() {
		if (jPanel131 == null) {
			...
			jPanel131.setBounds(new Rectangle(27, 109, 231, 36));
	...
	private JTextField getJTextField101() {
		if (jTextField101 == null) {
			...
			jTextField101.setBounds(new Rectangle(104, 5, 90, 25));
	...
	private JPanel getJPanel141() {
		if (jPanel141 == null) {
			...
			jPanel141.setBounds(new Rectangle(28, 152, 231, 40));
	...
	private JCheckBox getJCheckBox51() {
		if (jCheckBox51 == null) {
			...
			jCheckBox51.setBounds(new Rectangle(4, 4, 102, 31));
	...
	private JTextField getJTextField111() {
		if (jTextField111 == null) {
			...
			jTextField111.setBounds(new Rectangle(108, 8, 95, 26));

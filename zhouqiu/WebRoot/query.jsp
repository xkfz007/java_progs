...
<html:form action="query.do" method="post">
	...
	<hr color="#99CCFF">
    <center>
    <font color="#66CCFF" size="+1">南昌航空大学</font>
    </center>
    <hr color="#99CCFF">	
	 <tr>
	 ...
	 <tr>
	  ...
	  <tr>
	  <td>题&nbsp&nbsp&nbsp&nbsp目:</td>
	  <td><html:text property ="name3"/></td>
	  <td>检索文章的题目检索文章的题目</td>
	  <tr>
	   <tr>
	  <td></td>
	  <td>（支持模糊查找）</td>
	  ...
	  <tr>
	  <td>摘要题目:</td>
	  <td><html:text property ="name4"/></td>
	  <td>检索文章的摘要或题目</td>
	  </tr>
	  <tr>
	 <td></td>
	 ...
	 <tr>
	  <td>关键&nbsp&nbsp词:</td>
	  <td><html:text property ="name5"/></td>
	  <td>检索文章的关键词目</td>
	  </tr>
	   <tr>
	  <td></td>
	  ...
	  <tr>
	  <td>分类&nbsp&nbsp号:</td>
	  <td><html:text property ="name6"/></td>
	  <td>检索文章的分类号或PACS</td>
	  </tr>
	  <tr>
	  <td></td>
<td><html:submit value="确定"/><html:cancel value="重写"/></td></center>
	  <td></td>
	  </tr>
	 </table>
</html:form>

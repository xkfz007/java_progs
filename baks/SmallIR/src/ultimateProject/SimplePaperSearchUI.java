...
public class SimplePaperSearchUI extends JFrame {
	...
	private JPanel getJPanel() {
		if (jPanel == null) {
			jLabel6 = new JLabel();
			jLabel6.setBounds(new Rectangle(15, 799, 718, 31));
			jLabel6.setText("<html><p><strong><font size=\"4\" color=\"blue\">&nbsp;&nbsp;&nbsp;" +
					"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &copy;2010 " +
					"Chinese Academy of Science ,made by Hu Fangzhen&Zhang Chunming</font></strong></p></html>");
	...
	private JPanel getJPanel1() {
		if (jPanel1 == null) {
			...
			jPanel1.setBounds(new Rectangle(12, 12, 721, 53));
	...
	private JTextField getJTextField() {
		if (jTextField == null) {
			...
			jTextField.setBounds(new Rectangle(97, 6, 223, 40));
	...
	private JButton getJButton() {
		if (jButton == null) {
			jButton = new JButton();
			jButton.setBounds(new Rectangle(389, 11, 67, 31));
...
//		显示搜索时间和文档数目
	...
	private JButton getJButton1() {
		if (jButton1 == null) {
			...
			jButton1.setBounds(new Rectangle(630, 8, 82, 39));
	...
	private JScrollPane getJScrollPane() {
		if (jScrollPane == null) {
			...
			jScrollPane.setBounds(new Rectangle(14, 125, 720, 670));
	...
	private JPanel getJPanel2() {
		if (jPanel2 == null) {
			...
			jPanel2.setBounds(new Rectangle(13, 68, 721, 53));
	...
	private JButton getJButton2() {
		if (jButton2 == null) {
			...
			jButton2.setBounds(new Rectangle(465, 10, 84, 33));
	...
	private JCheckBox getJCheckBox() {
		if (jCheckBox == null) {
			...
			jCheckBox.setBounds(new Rectangle(326, 11, 55, 28));
	...
	private JComboBox getJComboBox1() {
		if (jComboBox1 == null) {
			...
			jComboBox1.setBounds(new Rectangle(560, 8, 61, 37));
